                ...
                <div className="flex flex-col gap-10 md:flex-row-reverse justify-between items-center mt-10">
                  <div className="max-w-[500px]">
                    ...
                    <div className="section-content text-left lg:text-right">
                      ...
                      individuality. Additionally, Bonanza NFTs serve as
                      lifelong assets that provide IRL utility. Allowing holders
                      to meet one another at our global events.
                      <br />
                      <br />
                ...
                <div className="flex flex-col gap-10 md:flex-row justify-between items-center mt-10">
                  <div className="max-w-[500px]">
                    ...
                    <div className="section-content">
                      ...
                      <br />
                      <br />
                      Ian and Johnathon meticulously designed the
                      characteristics of this collection to their exact
                      specifications. Aggregating interests from traditional
                      Japanese anime, to urban fashion and hip-hop culture into
